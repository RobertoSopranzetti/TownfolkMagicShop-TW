<section class="container mt-5">
    <div class="text-center">
        ...
        <div class="d-grid gap-2 d-md-block mt-4">
            ...
            <a href="ordini.php" class="btn btn-success btn-lg me-md-2 mb-2" aria-label="Vedi Ordini">
                <i class="bi bi-card-list"></i> Vedi Ordini
            </a>
            <a href="notifiche.php" class="btn btn-success btn-lg me-md-2 mb-2" aria-label="Vedi Notifiche">
                <i class="bi bi-bell"></i> Vedi Notifiche
            </a>
            <form action="logout.php" method="POST" class="d-inline">
                <button type="submit" class="btn btn-danger btn-lg me-md-2 mb-2" aria-label="Logout">
