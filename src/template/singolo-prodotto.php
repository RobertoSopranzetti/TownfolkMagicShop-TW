...
<?php else:
    ...
    <div class="container mt-5">
        <div class="text-center">
            <h1><?php echo htmlspecialchars($prodotto["titolo"]); ?></h1>
        </div>
        <div class="row mt-4">
            <div class="col-12 col-md-6 mb-3">
                <img src="<?php echo UPLOAD_DIR . htmlspecialchars($prodotto["immagine"]); ?>"
                    alt="<?php echo htmlspecialchars($prodotto["titolo"]); ?>" class="img-fluid">
            </div>
            <div class="col-12 col-md-6 mb-3">
                <div class="d-flex align-items-center mb-3">
                    ...
                    <input type="number" id="quantity" name="quantity" class="form-control quantity-input" min="1"
                        max="<?php echo htmlspecialchars($prodotto["quantita_disponibile"]); ?>" value="1">
                </div>
                <div class="d-flex align-items-center mb-3">
                ...
                <div class="mb-3">
                    <button class="btn btn-primary w-100"
                        onclick="aggiungiAlCarrello(<?php echo $prodotto['id']; ?>)">Aggiungi al Carrello</button>
                </div>
                <div class="mt-4">
